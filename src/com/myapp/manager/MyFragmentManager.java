...
//		fragmanager.beginTransaction().replace(R.id.fragment_layout, fm).addToBackStack(null).commit();
//	}
//
...
//		fragmentManager.beginTransaction().replace(R.id.home_fragment_layout, fm).addToBackStack(null).commit();
//	}
//	
//	public static void microBlogFragmentChange(FragmentManager fragmanager,Fragment fm){
//		fragmanager.beginTransaction().replace(R.id.user_fragment_layout, fm).addToBackStack(null).commit();
//	}	
//	
//	public static void microBlogFriendsFragmentChange(FragmentManager fragmanager,Fragment fm){
//		fragmanager.beginTransaction().replace(R.id.friends_fragment_layout, fm).addToBackStack(null).commit();
//	}
	public static void myChangeFragment(FragmentManager fragmanager,Fragment fm){
